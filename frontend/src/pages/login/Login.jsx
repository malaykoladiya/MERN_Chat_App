        ...
        <div className='flex flex-col items-center justify-center min-w-96 mx-auto border border-black border-opacity-50 rounded-lg shadow-xl'>
            ...
            <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
                <h1 className='text-3xl font-semibold text-center text-gray-50'>
                    Login <span className='text-gray-50'>ChatApp</span>
                </h1>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Link to = {'/signup'} className='text-sm text-gray-50 hover:underline hover:text-yellow-300 mt-2 inline-block' >
...
//               <h1 className='text-3xl font-semibold text-center text-gray-50'>
//                   Login
//                   <span className='text-gray-50'>ChatApp</span>
//               </h1>
...
//                       <input type = 'password' placeholder='Enter password' className='w-full input input-bordered h-10'/>
//                   </div>
//                   <a href = '#' className='text-sm text-gray-50 hover:underline hover:text-yellow-300 mt-2 inline block' >
//                       {"Don't"} have an account?
//                   </a>
